...
public interface StrictJsonWriter {
     ...
     * @throws me.levansj01.verus.util.bson.BsonInvalidOperationException if not in the correct state to write a member name
     * @throws me.levansj01.verus.util.bson.BSONException if the underlying Writer throws an IOException
     */
     ...
     * @throws me.levansj01.verus.util.bson.BsonInvalidOperationException if not in the correct state to write a value
     * @throws me.levansj01.verus.util.bson.BSONException if the underlying Writer throws an IOException
     */
     ...
     * @param name  the member name
     * @param value the boolean value
     * @throws me.levansj01.verus.util.bson.BsonInvalidOperationException if not in the correct state to write a member
     * @throws me.levansj01.verus.util.bson.BSONException if the underlying Writer throws an IOException
     */
     ...
     *
     * @throws me.levansj01.verus.util.bson.BsonInvalidOperationException if not in the correct state to write the end of an array
     * @throws me.levansj01.verus.util.bson.BSONException if the underlying Writer throws an IOException
     */
    void writeEndArray();
     ...
     *
     * @throws me.levansj01.verus.util.bson.BsonInvalidOperationException if not in the correct state to write the end of an object
     * @throws me.levansj01.verus.util.bson.BSONException if the underlying Writer throws an IOException
     */
    void writeEndObject();
