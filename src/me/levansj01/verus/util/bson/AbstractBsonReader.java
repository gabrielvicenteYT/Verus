...
public abstract class AbstractBsonReader implements BsonReader {
    ...
    /**
     * Returns the next {@code State} to transition to, based on the {@link me.levansj01.verus.util.bson.AbstractBsonReader.Context} of this reader.
     *
     ...
     * reader. Also records the {@link me.levansj01.verus.util.bson.BsonContextType}, indicating whether the reader is reading a document, array, or other
