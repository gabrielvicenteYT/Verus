 ...
 *
 * <p>This class is a part of legacy API. Please check {@link me.levansj01.verus.util.bson.codecs.Encoder} for a new one.</p>
 */
public interface BSONEncoder {
     ...
     * <ul>
     * <li>{@link #set(me.levansj01.verus.util.bson.io.OutputBuffer)}</li>
