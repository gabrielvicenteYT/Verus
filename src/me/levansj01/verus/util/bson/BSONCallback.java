...
public interface BSONCallback {
     ...
     * @see me.levansj01.verus.util.bson.BsonType#NULL
     */
    void gotNull(String name);

    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#UNDEFINED} value.
     *
     * @param name the name of the field
     * @see me.levansj01.verus.util.bson.BsonType#UNDEFINED
     */
    void gotUndefined(String name);

    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#MIN_KEY} value.
     *
     * @param name the name of the field
     */
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#MAX_KEY} value.
     *
     * @param name the name of the field
     */
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#BOOLEAN} value.
     *
     * @param name  the name of the field
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#DOUBLE} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#DECIMAL128} value.
     *
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#INT32} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#INT64} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#DATE_TIME} value.
     *
     * @param name   the name of the field
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#STRING} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#SYMBOL} value.
     *
     * @param name  the name of the field
     * @param value the field's value
     */
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#REGULAR_EXPRESSION} value.
     *
     * @param name    the name of the field
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#TIMESTAMP} value.
     *
     * @param name      the name of the field
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#OBJECT_ID} value.
     *
     * @param name the name of the field
    ...
    /**
     * Invoked when {@link me.levansj01.verus.util.bson.BSONDecoder} encountered a {@link me.levansj01.verus.util.bson.BsonType#DB_POINTER} type field in a byte sequence.
     *
     * @param name      the name of the field
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#BINARY} value. Note that binary values have a subtype, which may
     * determine how the value is processed.
     *
     * @param name the name of the field
     * @param type one of the binary subtypes: {@link me.levansj01.verus.util.bson.BsonBinarySubType}
     ...
     * {@link me.levansj01.verus.util.bson.BsonBinarySubType#UUID_LEGACY}
     *
     * @param name  the name of the field
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#JAVASCRIPT} value.
     *
     * @param name the name of the field
    ...
    /**
     * Called when reading a field with a {@link me.levansj01.verus.util.bson.BsonType#JAVASCRIPT_WITH_SCOPE} value.
     *
     * @param name  the name of the field
     * @param code  the JavaScript code
