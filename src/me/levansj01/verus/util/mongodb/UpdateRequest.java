...
class UpdateRequest extends WriteRequest {
    ...
    @Override
    me.levansj01.verus.util.mongodb.internal.bulk.WriteRequest toNew(final DBCollection dbCollection) {
        return new me.levansj01.verus.util.mongodb.internal.bulk.UpdateRequest(new BsonDocumentWrapper<DBObject>(query, codec),
                                                       new BsonDocumentWrapper<DBObject>(update, codec),
                                                       me.levansj01.verus.util.mongodb.internal.bulk.WriteRequest.Type.UPDATE)
               .upsert(isUpsert())
               .multi(isMulti())
