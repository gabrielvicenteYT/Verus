 ...
 * @see me.levansj01.verus.util.mongodb.DBCollection#initializeUnorderedBulkOperation()
 *
...
public class BulkWriteOperation {
     ...
     * @throws me.levansj01.verus.util.mongodb.BulkWriteException if the write failed due some other failure specific to the write command
