...
import me.levansj01.verus.util.mongodb.internal.connection.ServerAddressHelper;
import me.levansj01.verus.util.mongodb.internal.selector.LatencyMinimizingServerSelector;
...
public final class ClusterSettings {
    ...
    public static final class Builder {
         ...
         * {@link me.levansj01.verus.util.mongodb.MongoTimeoutException} will be thrown.  The default value is 30 seconds.
         *
     ...
     * {@link me.levansj01.verus.util.mongodb.connection.ClusterDescription} which is passed to it contains a list of
     * {@link me.levansj01.verus.util.mongodb.connection.ServerDescription} instances which satisfy either the configured {@link me.levansj01.verus.util.mongodb.ReadPreference}
     ...
     * handle a request, a {@link me.levansj01.verus.util.mongodb.MongoTimeoutException} will be thrown.  The default value is 30 seconds.
     *
     * <p> A value of 0 means that it will timeout immediately if no server is available.  A negative value means to wait
     * indefinitely.</p>
     *
