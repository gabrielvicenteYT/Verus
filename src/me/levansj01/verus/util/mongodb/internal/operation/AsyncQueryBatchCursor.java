...
import me.levansj01.verus.util.mongodb.internal.async.AsyncAggregateResponseBatchCursor;
...
import static me.levansj01.verus.util.mongodb.assertions.Assertions.assertFalse;
...
import static me.levansj01.verus.util.mongodb.internal.operation.CursorHelper.getNumberToReturn;
import static me.levansj01.verus.util.mongodb.internal.operation.OperationHelper.LOGGER;
import static me.levansj01.verus.util.mongodb.internal.operation.OperationHelper.getMoreCursorDocumentToQueryResult;
import static me.levansj01.verus.util.mongodb.internal.operation.QueryHelper.translateCommandException;
    ...
    private void killCursorAsynchronouslyAndReleaseConnectionAndSource(final AsyncConnection connection, final ServerCursor localCursor) {
        if (serverIsAtLeastVersionThreeDotTwo(connection.getDescription())) {
            connection.commandAsync(namespace.getDatabaseName(), asKillCursorsCommandDocument(localCursor), NO_OP_FIELD_NAME_VALIDATOR,
                    ...
                    connectionSource.getServerApi(), new SingleResultCallback<BsonDocument>() {
                        @Override
