...
final class ConnectionPoolListenerMulticaster implements ConnectionPoolListener {
    ...
    @Override
    public void connectionPoolOpened(final me.levansj01.verus.util.mongodb.event.ConnectionPoolOpenedEvent event) {
    ...
    @Override
    public void connectionRemoved(final me.levansj01.verus.util.mongodb.event.ConnectionRemovedEvent event) {
        for (ConnectionPoolListener cur : connectionPoolListeners) {
            try {
    ...
    @Override
    public void connectionAdded(final me.levansj01.verus.util.mongodb.event.ConnectionAddedEvent event) {
        for (ConnectionPoolListener cur : connectionPoolListeners) {
            try {
