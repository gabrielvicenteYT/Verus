...
import me.levansj01.verus.util.mongodb.MongoSocketClosedException;
import me.levansj01.verus.util.mongodb.MongoSocketReadException;
import me.levansj01.verus.util.mongodb.MongoSocketReadTimeoutException;
import me.levansj01.verus.util.mongodb.MongoSocketWriteException;
import me.levansj01.verus.util.mongodb.ServerAddress;
import me.levansj01.verus.util.mongodb.annotations.NotThreadSafe;
import me.levansj01.verus.util.mongodb.connection.AsyncCompletionHandler;
...
import me.levansj01.verus.util.mongodb.connection.ServerConnectionState;
...
import me.levansj01.verus.util.mongodb.connection.Stream;
...
import static me.levansj01.verus.util.mongodb.internal.connection.MessageHeader.MESSAGE_HEADER_LENGTH;
import static me.levansj01.verus.util.mongodb.internal.connection.OpCode.OP_COMPRESSED;
import static me.levansj01.verus.util.mongodb.internal.connection.ProtocolHelper.createSpecialWriteConcernException;
import static me.levansj01.verus.util.mongodb.internal.connection.ProtocolHelper.getClusterTime;
import static me.levansj01.verus.util.mongodb.internal.connection.ProtocolHelper.getCommandFailureException;
import static me.levansj01.verus.util.mongodb.internal.connection.ProtocolHelper.getMessageSettings;
import static me.levansj01.verus.util.mongodb.internal.connection.ProtocolHelper.getOperationTime;
import static me.levansj01.verus.util.mongodb.internal.connection.ProtocolHelper.getRecoveryToken;
import static me.levansj01.verus.util.mongodb.internal.connection.ProtocolHelper.isCommandOk;
...
public class InternalStreamConnection implements InternalConnection {
    ...
    private Compressor createCompressor(final MongoCompressor mongoCompressor) {
        ...
        } else if (mongoCompressor.getName().equals("zstd")) {
