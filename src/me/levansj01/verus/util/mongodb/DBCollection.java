...
import me.levansj01.verus.util.mongodb.BasicDBObject;
import me.levansj01.verus.util.mongodb.DBObject;
import me.levansj01.verus.util.mongodb.DBObjectCodec;
import me.levansj01.verus.util.mongodb.DBObjectFactory;
...
import me.levansj01.verus.util.mongodb.MongoWriteConcernException;
...
import me.levansj01.verus.util.mongodb.WriteConcernException;
import me.levansj01.verus.util.mongodb.WriteConcernResult;
import me.levansj01.verus.util.mongodb.annotations.ThreadSafe;
import me.levansj01.verus.util.mongodb.client.model.DBCollectionCountOptions;
import me.levansj01.verus.util.mongodb.client.model.DBCollectionDistinctOptions;
import me.levansj01.verus.util.mongodb.client.model.DBCollectionFindAndModifyOptions;
import me.levansj01.verus.util.mongodb.client.model.DBCollectionFindOptions;
import me.levansj01.verus.util.mongodb.client.model.DBCollectionRemoveOptions;
import me.levansj01.verus.util.mongodb.client.model.DBCollectionUpdateOptions;
...
import me.levansj01.verus.util.mongodb.internal.bulk.WriteRequest.Type;
import me.levansj01.verus.util.mongodb.internal.operation.AggregateOperation;
import me.levansj01.verus.util.mongodb.internal.operation.AggregateToCollectionOperation;
import me.levansj01.verus.util.mongodb.internal.operation.BaseWriteOperation;
import me.levansj01.verus.util.mongodb.internal.operation.BatchCursor;
import me.levansj01.verus.util.mongodb.internal.operation.CountOperation;
import me.levansj01.verus.util.mongodb.internal.operation.CreateIndexesOperation;
import me.levansj01.verus.util.mongodb.internal.operation.DeleteOperation;
import me.levansj01.verus.util.mongodb.internal.operation.DistinctOperation;
import me.levansj01.verus.util.mongodb.internal.operation.DropCollectionOperation;
import me.levansj01.verus.util.mongodb.internal.operation.DropIndexOperation;
import me.levansj01.verus.util.mongodb.internal.operation.FindAndDeleteOperation;
import me.levansj01.verus.util.mongodb.internal.operation.FindAndReplaceOperation;
import me.levansj01.verus.util.mongodb.internal.operation.FindAndUpdateOperation;
import me.levansj01.verus.util.mongodb.internal.operation.InsertOperation;
import me.levansj01.verus.util.mongodb.internal.operation.ListIndexesOperation;
import me.levansj01.verus.util.mongodb.internal.operation.MapReduceBatchCursor;
import me.levansj01.verus.util.mongodb.internal.operation.MapReduceStatistics;
import me.levansj01.verus.util.mongodb.internal.operation.MapReduceToCollectionOperation;
import me.levansj01.verus.util.mongodb.internal.operation.MapReduceWithInlineResultsOperation;
import me.levansj01.verus.util.mongodb.internal.operation.MixedBulkWriteOperation;
import me.levansj01.verus.util.mongodb.internal.operation.ReadOperation;
import me.levansj01.verus.util.mongodb.internal.operation.RenameCollectionOperation;
import me.levansj01.verus.util.mongodb.internal.operation.UpdateOperation;
import me.levansj01.verus.util.mongodb.internal.operation.WriteOperation;
...
import static me.levansj01.verus.util.mongodb.BulkWriteHelper.translateBulkWriteResult;
import static me.levansj01.verus.util.mongodb.MongoNamespace.checkCollectionNameValidity;
import static me.levansj01.verus.util.mongodb.ReadPreference.primary;
import static me.levansj01.verus.util.mongodb.ReadPreference.primaryPreferred;
import static me.levansj01.verus.util.mongodb.assertions.Assertions.notNull;
import static me.levansj01.verus.util.mongodb.internal.bulk.WriteRequest.Type.UPDATE;
...
public class DBCollection {
     ...
     * @throws me.levansj01.verus.util.mongodb.DuplicateKeyException if the write failed to a duplicate unique key
     * @throws me.levansj01.verus.util.mongodb.WriteConcernException if the write failed due some other failure specific to the insert command
     * @throws me.levansj01.verus.util.mongodb.MongoCommandException if the write failed due to a specific command exception
     ...
     * @return the result of the operation
     * @throws me.levansj01.verus.util.mongodb.MongoCommandException if the write failed due to a specific command exception
     * @throws me.levansj01.verus.util.mongodb.MongoException             if the write failed due some other failure
     * @mongodb.driver.manual tutorial/insert-documents/ Insert Documents
     */
     ...
     * @return the result of the operation
     * @throws me.levansj01.verus.util.mongodb.DuplicateKeyException if the write failed to a duplicate unique key
     * @throws me.levansj01.verus.util.mongodb.WriteConcernException if the write failed due some other failure specific to the insert or update command
     * @throws me.levansj01.verus.util.mongodb.MongoCommandException if the write failed due to a specific command exception
     * @throws MongoException if the operation failed for some other reason
     ...
     * @return the result of the operation
     * @throws me.levansj01.verus.util.mongodb.DuplicateKeyException if the write failed to a duplicate unique key
     * @throws me.levansj01.verus.util.mongodb.WriteConcernException if the write failed due some other failure specific to the update command
     * @throws me.levansj01.verus.util.mongodb.MongoCommandException if the write failed due to a specific command exception
     * @throws MongoException if the operation failed for some other reason
     ...
     *              in the collection.
     * @return the result of the operation
     * @throws me.levansj01.verus.util.mongodb.WriteConcernException if the write failed due some other failure specific to the delete command
     * @throws me.levansj01.verus.util.mongodb.MongoCommandException if the write failed due to a specific command exception
     * @throws MongoException if the operation failed for some other reason
     ...
     *
     * @return the {@link me.levansj01.verus.util.mongodb.ReadConcern}
     * @since 3.3
     * @mongodb.server.release 3.2
     * @mongodb.driver.manual reference/readConcern/ Read Concern
     */
    ...
    private List<me.levansj01.verus.util.mongodb.internal.bulk.WriteRequest> translateWriteRequestsToNew(final List<WriteRequest> writeRequests) {
        List<me.levansj01.verus.util.mongodb.internal.bulk.WriteRequest> retVal = new ArrayList<me.levansj01.verus.util.mongodb.internal.bulk.WriteRequest>(writeRequests.size());
