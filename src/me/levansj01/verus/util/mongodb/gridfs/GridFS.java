...
package me.levansj01.verus.util.mongodb.gridfs;

import me.levansj01.verus.util.mongodb.BasicDBObject;
import me.levansj01.verus.util.mongodb.DB;
import me.levansj01.verus.util.mongodb.DBCollection;
import me.levansj01.verus.util.mongodb.DBCursor;
...
public class GridFS {
     ...
     * @throws me.levansj01.verus.util.mongodb.MongoException if there's a failure
     * @see me.levansj01.verus.util.mongodb.WriteConcern
     */
     ...
     * @throws me.levansj01.verus.util.mongodb.MongoException if the operation fails
     */
    ...
    /**
     * Creates a file entry. After calling this method, you have to call {@link me.levansj01.verus.util.mongodb.gridfs.GridFSInputFile#save()}.
     *
